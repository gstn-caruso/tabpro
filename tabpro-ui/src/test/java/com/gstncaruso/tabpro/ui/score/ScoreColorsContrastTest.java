...
class ScoreColorsContrastTest {
    ...
    private static List<Pair> pairs() {
        List<Pair> pairs = new ArrayList<>(List.of(
                ...
                new Pair("tempo (TEMPO) / fondo", ScoreColors.TEMPO, ScoreColors.BACKGROUND,
                        Contrast.TEXT_MINIMUM_RATIO),
                ...
                new Pair("borde (BORDER) / panel de pistas", ScoreColors.BORDER, ScoreColors.SURFACE,
                        Contrast.GRAPHICAL_MINIMUM_RATIO),
                new Pair("banda de titulo (TITLE_BAR) / panel de pistas", ScoreColors.TITLE_BAR, ScoreColors.SURFACE,
                        Contrast.GRAPHICAL_MINIMUM_RATIO),
                new Pair("tinta de la banda de titulo (TITLE_BAR_INK) / banda de titulo (TITLE_BAR)",
