...
class TimeSignaturePaintingTest {
    ...
    void writesTheBeatsGlyphAboveTheBeatUnitGlyphOnTheMiddleStaffLines() {
        ...
        RecordingCanvas lienzo = paint(new TimeSignature(4, 4), layout);

        String four = MusicFont.timeSignatureDigit(4);
        assertTrue(lienzo.writesTextInRegion(four, new Rectangle(0, layout.staffLineY(0, 0, 3) - 2, WIDTH, 4)),
                "el numerador tiene que escribir el digito de Bravura sobre la linea del medio de arriba");
        assertTrue(lienzo.writesTextInRegion(four, new Rectangle(0, layout.staffLineY(0, 0, 1) - 2, WIDTH, 4)),
    ...
    void aTwoDigitBeatCountIsAssembledGlyphByGlyph() {
        ...
        RecordingCanvas lienzo = paint(new TimeSignature(12, 8), layout);

        String twelve = MusicFont.timeSignatureDigit(1) + MusicFont.timeSignatureDigit(2);
        assertTrue(lienzo.writesTextInRegion(twelve, new Rectangle(0, layout.staffLineY(0, 0, 3) - 2, WIDTH, 4)),
