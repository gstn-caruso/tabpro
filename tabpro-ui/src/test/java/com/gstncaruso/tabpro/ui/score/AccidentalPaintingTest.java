...
class AccidentalPaintingTest {
    ...
    void aNoteOutsideTheKeyIsMarkedWithTheSharpGlyph() {
        ...
        assertTrue(lienzo.writesTextInRegion(MusicFont.accidentalSharp(), new Rectangle(0, y - 2, WIDTH, 4)),
    ...
    void aFlatKeySignatureIsWrittenWithTheFlatGlyph() {
        ...
        assertTrue(lienzo.writesTextInRegion(MusicFont.accidentalFlat(), new Rectangle(0, y - 2, WIDTH, 4)),
    ...
    void aNoteReturningToTheKeyAfterASharpIsMarkedWithTheNaturalGlyph() {
        ...
        int y = layout.stepY(0, 0, step);
        assertTrue(lienzo.writesTextInRegion(MusicFont.accidentalNatural(), new Rectangle(0, y - 2, WIDTH, 4)),
