...
**v0.4.1 — Multipista.** Editor de tablatura con edición por teclado al estilo
...
```sh
sudo apt install ./tabpro_0.4.1_all.deb
tabpro
```
...
```sh
java -jar tabpro-app/target/tabpro-app-0.4.1.jar
```
