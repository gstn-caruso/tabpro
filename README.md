...
**v0.2.0 — MVP.** Editor de tablatura de una pista con edición por teclado al estilo
...
```sh
sudo apt install ./tabpro_0.2.0_all.deb
tabpro
```
...
```sh
java -jar tabpro-app/target/tabpro-app-0.2.0.jar
```
